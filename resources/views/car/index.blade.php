    ...
    <div class="card mb-12 mb-xl-12" id="kt_profile_details_view" style="margin: 10px; padding: 10px">
        <div class="row">
            <div class="d-flex justify-content-between margin-tb">
                ...
                <a class="btn btn-success" href="{{ route('car.create') }}">Create</a>
            </div>
        </div>
    </div>
        ...
        <table class="table table-bordered table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
            ...
            @foreach ($cars as $key => $car)
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a class="" style="margin-right: 10px" href="{{ route('car.show',$car->id) }}">
                                <span class="fa fa-eye"></span>
                            </a>
                            <a class="" style="margin-right: 2px" href="{{ route('car.edit',$car->id) }}">
