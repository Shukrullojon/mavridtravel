...
@section('content')
    ...
    <div class="card mb-12 mb-xl-12" id="kt_profile_details_view" style="margin: 10px; padding: 10px">
        ...
        {!! Form::model($date, ['method' => 'PATCH','route' => ['date.update', $date->id]]) !!}
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::select('trip_id', $trips,$date->trip_id, ['class' => 'form-control']) !!}
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::select('car_id', $cars,$date->car_id, ['class' => 'form-control']) !!}
                </div>
            </div>
